class RotaryDial {
	...
	draw(){
		...
		// const discGradient = this.c.createRadialGradient(this.w2, this.h2, 0, this.w2, this.h2, this.outerCircle);
		// discGradient.addColorStop(0, '#00c6a3');
		// discGradient.addColorStop(1, '#4bd7be');
		const discGradient = this.c.createRadialGradient(this.w2, this.h2, this.innerCircle, this.w2, this.h2, this.outerCircle);
		discGradient.addColorStop(0, '#009580'); // Darker shade for inner circle
		discGradient.addColorStop(0.8, '#00c6a3'); // Middle shade 
		discGradient.addColorStop(1, '#009580'); 
		...
		this.c.fillStyle = discGradient;
		this.c.fill();

		// Apply shadow properties to discStrokeColor
		
		
		// Apply the gradient
		this.c.strokeStyle = discGradient;
		this.c.stroke();

		 // Reset shadow properties after drawing the disc
